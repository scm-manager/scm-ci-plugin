...
## 3.3.0 - 2026-01-20
### Added
- Enhance MCP tool for commits with CI status in result details

## 3.2.1 - 2026-01-13
### Fixed
- Broken translation for obsolete readCIStatus permission, if it is still set for a repository role
