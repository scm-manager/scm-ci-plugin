...
class ChangesetDeploymentStatusEnricherTest {

  private final Repository repository = new Repository("1337", "git", "pokemon", "emerald");
  private final Changeset changeset = new Changeset("123", System.currentTimeMillis(), null);
  ...
  private ChangesetDeploymentStatusEnricher enricher;
  ...
  void setup() {
    ...
    enricher = new ChangesetDeploymentStatusEnricher(pathBuilder);
  }
  ...
  void shouldAppendLink() {
    ...
    verify(appender).appendLink(
      "deploymentStatus",
      "https://scm.com/api/v2/deployments/pokemon/emerald/changesets/123"
    );
  }
}
